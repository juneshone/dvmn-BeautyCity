    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        blank=True, null=True, verbose_name="Номер записи"
                    ),
                ),
                (
                    "operation_id",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="ID операции"
                    ),
                ),
                (
                    "amount",
                ...
                (
                    "is_success",
                    models.BooleanField(blank=True, null=True, verbose_name="Успешно"),
                ),
            ],
            options={
                "verbose_name": "Платеж",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phonenumber",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Телефон"
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("PAID", "Оплаченный"), ("NOT_PAID", "Не оплаченный")],
                        default="NOT_PAID",
                        max_length=50,
                        verbose_name="Статус",
                    ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="beauty_salons.servicecategory",
            ),
        ),
        migrations.AddField(
            model_name="master",
            ...
            field=models.ManyToManyField(
                related_name="masters_profiles", to="beauty_salons.servicecategory"
            ),
        ),
    ]
