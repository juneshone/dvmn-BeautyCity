    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phonenumber', models.CharField(max_length=100, unique=True, verbose_name='Телефон')),
        ...
        migrations.AddField(
            model_name='master',
            name='profile',
            field=models.ManyToManyField(related_name='masters_profiles', to='beauty_salons.servicecategory'),
        ),
    ]
